"""Number Stub for Enphase Envoy solar energy monitor with support for legacy.
...
"""
import homeassistant.components.enphase_envoy.number as ee_number
...
async def async_setup_entry(
    ...
    """Set up core enphase envoy integration number platform."""
    await ee_number.async_setup_entry(hass, config_entry, async_add_entities)
