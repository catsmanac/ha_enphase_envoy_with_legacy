"""Sensor Stub for Enphase Envoy solar energy monitor with support for legacy.
...
"""
import homeassistant.components.enphase_envoy.sensor as ee_sensor
...
async def async_setup_entry(
    ...
    """Set up core enphase envoy integration sensor platform."""
    await ee_sensor.async_setup_entry(hass, config_entry, async_add_entities)
