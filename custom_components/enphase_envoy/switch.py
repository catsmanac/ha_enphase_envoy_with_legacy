"""Switch Stub for Enphase Envoy solar energy monitor with support for legacy.
...
"""
import homeassistant.components.enphase_envoy.select as ee_switch
...
async def async_setup_entry(
    ...
    """Set up core enphase envoy integration switch platform."""
    await ee_switch.async_setup_entry(hass, config_entry, async_add_entities)
